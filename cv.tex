...
\section{interests}
single page applications, REST APIs, mobile first design, material design, user experience, web accessibility, continuous integration and delivery, automated deployment, automated acceptance tests 
...
\entry
  ...
  {SOFTWARE DEVELOPER}
  {
    ...
    \textbf{\textsc{react, redux, gitlab, sketch, selenium, perl, javascript}}
    \vspace{10pt}
  }
\entry
  {2017}
